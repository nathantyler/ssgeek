...
<section id="inner-planets" class="planets">
    ...
    <section class="planet">
        <h2>Mercury</h2>
        <c:set var="mercuryImgSrc" value="${ baseUrl }/img/mercury.jpg" />
    ...
    <section class="planet">
        <h2>Venus</h2>
        <c:set var="venusImgSrc" value="${ baseUrl }/img/venus.jpg" />
    ...
    <section class="planet">
        <h2>Earth</h2>
        <c:set var="earthImgSrc" value="${ baseUrl }/img/earth.jpg" />
    ...
    <section class="planet">
        <h2>Mars</h2>
        <c:set var="marsImgSrc" value="${ baseUrl }/img/mars.jpg" />
...
<section id="outer-planets" class="planets">
    ...
    <section class="planet">
        <h2>Jupiter</h2>
        <c:set var="jupiterImgSrc" value="${ baseUrl }/img/jupiter.jpg" />
    ...
    <section class="planet">
        <h2>Saturn</h2>
        <c:set var="saturnImgSrc" value="${ baseUrl }/img/saturn.jpg" />
    ...
    <section class="planet">
        <h2>Uranus</h2>
        <c:set var="uranusImgSrc" value="${ baseUrl }/img/uranus.jpg" />
    ...
    <section class="planet">
        <h2>Neptune</h2>
        <c:set var="neptuneImgSrc" value="${ baseUrl }/img/neptune.jpg" />
